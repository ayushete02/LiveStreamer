    ...
    <div class="px-16 bg-white">
        <div class="container flex flex-col items-start mx-auto lg:items-center">
            ...
            <h2 class="relative flex items-start justify-start w-full max-w-3xl text-5xl font-bold lg:justify-center">
                ...
                Collaborator</h2>
                <div class="block w-full h-0.5 max-w- mt-6 bg-purple-100 rounded-full"></div>

            <div class="items-center justify-center w-full mt-12 mb-4 lg:flex ">
                <div class="flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-2/3 lg:mb-0 m-5 p-10 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 ">
                    <div class="flex items-center justify-center">
                        ...
                        <div class="flex flex-col items-start justify-center">
                            <h4 class="font-bold text-gray-800">Ayush Shete</h4>
                            <p class="text-gray-600">Student</p>
                        </div>
                    </div>
                    <blockquote class="mt-8 text-lg text-gray-500">"Developer"</blockquote>
                </div>
                ...
                <div class="flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-2/3 lg:mb-0 m-5 p-10 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 ">
                    <div class="flex items-center justify-center">
                        ...
                        <div class="flex flex-col items-start justify-center">
                            <h4 class="font-bold text-gray-800">Harsh Gupta</h4>
                            <p class="text-gray-600">Student</p>
                        </div>
                    </div>
                    <blockquote class="mt-8 text-lg text-gray-500">"Developer"</blockquote>
